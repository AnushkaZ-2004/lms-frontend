...
const LecturerForm = ({ lecturer, onSubmit, onCancel }) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 ${errors.department ? 'border-red-300' : 'border-gray-300'
                        }`}
            ...
            <div className="flex justify-end space-x-3 pt-4">
                ...
                >
                    ...
                    <span>{loading ? 'Saving...' : 'Save Lecturer'}</span>
                </button>
            </div>
        </form>
    );
